...
# placeholder). Prefer the bundled app icon; fall back to an embedded 256x256
# placeholder if it is somehow missing.
ICON="$REPO_ROOT/build/CAMM3.png"
if [ -f "$REPO_ROOT/app/icons/CAMM3.png" ]; then
    cp "$REPO_ROOT/app/icons/CAMM3.png" "$ICON"
else
